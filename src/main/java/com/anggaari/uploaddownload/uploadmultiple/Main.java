package com.anggaari.uploaddownload.uploadmultiple;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MultipartBody.Part body1 = prepareFilePart("attachment", file1);
        MultipartBody.Part body2 = prepareFilePart("image", file2);
