package com.anggaari.uploaddownload.uploadpartmap;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // add part map within the multipart request
        RequestBody description = createPartFromString("hello, this is description speaking");
        RequestBody place = createPartFromString("Surabaya, Indonesia");
        RequestBody time = createPartFromString("2021-01-01");
